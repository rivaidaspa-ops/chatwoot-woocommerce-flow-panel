...
async function clearCache() { localStorage.removeItem(`regiones_${state.activeStore}_v86`); await api('/cache/clear', { method:'POST', body:'{}' }); setLoadingState('Limpio'); notifySuccess('Cache limpiado'); }
